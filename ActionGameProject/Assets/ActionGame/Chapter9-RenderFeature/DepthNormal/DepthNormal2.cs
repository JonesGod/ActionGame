...
public class DepthNormal2 : ScriptableRendererFeature
{
    class DepthNormalsPass : ScriptableRenderPass
    {
        ...
        {
            CommandBuffer cmd = CommandBufferPool.Get("GetDepthNormalpass");
    ...
    {
        depthNormalsMaterial = CoreUtils.CreateEngineMaterial("URPShader/Chapter9/DepthNormalTexture");
